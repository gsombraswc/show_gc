...
export default function TarjasFixas() {
    return (
        <Card className='bg-neutral-700 h-full flex flex-col rounded-md border-none'>
            <CardHeader>
                <CardTitle className='text-lime-300 mx-2 my-1'>Lorem Ipsum</CardTitle>
            ...
            <CardContent className='grow overflow-y-auto '>
                <ScrollArea className='flex flex-wrap items-center gap-2'>
                        ...
                        <div className='flex flex-col w-1/2 bg-neutral-50 max-w-[45%] rounded-md ml-2'>
                            <Image
                                alt='Image'
                                className='aspect-video bg-black rounded-t-md object-cover'
                                src={''} />
                            <p className='p-1 overflow-hidden text-nowrap leading-tight'>Titulo que pode ficar muito grande</p>
                        </div>
                        <div className='flex flex-col w-1/2 bg-neutral-50 max-w-[45%] rounded-md ml-2'>
                            <Image
                                alt='Image'
